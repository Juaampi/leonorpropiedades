...
export function Logo({ className, compact = false }: LogoProps) {
  return (
    <Link href="/" className={cn("inline-flex items-center gap-4", className)}>
      <span className="relative inline-flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl border border-white/30 bg-[linear-gradient(135deg,#f6dcc9_0%,#d8a876_35%,#b87489_100%)] shadow-[0_20px_40px_rgba(97,44,57,0.2)]">
        <svg viewBox="0 0 80 80" className="h-11 w-11" aria-hidden="true">
          <path d="M20 18h10v35h18v9H20V18Z" fill="#6B4A2B" />
          <path
